...
while True:
    ...
    print("minTemp, ", minLight)
    print("maxTemp, ", maxLight)
    
    if temperature < minTemp and blindStatus != "open":
        print("blind is to be opened")
        open_protocol()
        print("Blinds is now opened")
        update_status("open") #updates current blind status in firebase 
    ...
    if light < minLight and blindStatus != "open":
        print("blind is to be opened")
        open_protocol()
        print("Blinds is now opened")
        update_status("open") #updates current blind status in firebase 
    ...
    if temperature > maxTemp and blindStatus != "close":
        print("blind is to be closed")
        close_protocol()
        update_status("close") #updates current blind status in firebase 
        blindStatus = "close"  #updates current blind status on device
    ...
    if light > maxLight and blindStatus != "close":
        print("blind is to be closed")
        close_protocol()
        update_status("close") #updates current blind status in firebase 
        blindStatus = "close"  #updates current blind status on device
