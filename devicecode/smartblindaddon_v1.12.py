...
def check_max_light(cLight,mxLight,bstatus):
    if cLight > mxLight and bstatus == "open":
         return True
    else:
        return False    

def check_min_light(cLight,mnLight,bstatus):
    if cLight < mnLight and bstatus == "close":
         return True
    else:
        return False

def check_max_temp(cTemp,mxTemp,bstatus):
    if cTemp > mxTemp and bstatus == "open":
         return True
    else:
        return False    

def check_min_temp(cTemp,mnTemp,bstatus):
    if cTemp < mnTemp and bstatus == "close":
         return True
    else:
        return False 
...
while True:
    ...
    cmaxl = False
    cmaxl = check_max_light(int(light),int(maxLight),blindStatus)
    
    cminl = False
    cminl = check_min_light(int(light),int(minLight),blindStatus)
    ...
    cmaxt = False
    cmaxt = check_max_temp(tempt,int(maxTemp),blindStatus)
    
    cmint = False
    cmint = check_min_temp(tempt,int(minTemp),blindStatus)
